...
local camera = {
    ...
    nearClip = 0.01,
    farClip = 1000,
    aspectRatio = FRONT_WIDTH/FRONT_HEIGHT,--love.graphics.getWidth()/love.graphics.getHeight(), NightMeow 改动，仅渲染游戏时背景
    position = {0,0,0},
    target = {1,0,0},
    up = {0,0,1},
...
-- NightMeow 新增。设置横纵比，用于画布绘制（为什么没用啊）
function camera.setAspectRatio(w, h)
